...
const clickSeanceTime = async function (page) {
  await clickElement(page, config.selectors.seanceTime);
};
...
const prepareForSadTest = async function (page, day) {
  ...
  // необходимо 2 раза нажать на забронировать
